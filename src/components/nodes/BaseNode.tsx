  ...
  return (
    ...
    >
      ...
      <div className={`flex items-center gap-2 rounded-t-2xl px-3 py-2 ${color}`}>
        <span>{icon}</span>
        <span className="truncate text-sm font-semibold text-white">{data.name || 'Untitled'}</span>
      ...
      <div className="px-3 py-3 text-xs text-gray-300">
        {data.description || <span className="italic text-gray-500">Double-click to add description</span>}
      </div>
